...
class Scene extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      child: Container(
        // comprat63 (2:32)
        padding: EdgeInsets.fromLTRB(6*fem, 8*fem, 6*fem, 13*fem),
        width: double.infinity,
        ...
        child: Column(
          ...
          children: [
            Container(
              // autogroup8edvnhD (qVTujoRtoBdtfeAEZ8EDV)
            ...
            Container(
              // autogrouprjz3xk7 (qVU6pKJdq1RoaN41vRJz3)
              ...
              child: Column(
                ...
                children: [
                  ...
                  Container(
                    // autogroupfwxdMXM (qVUNorf7w8ViqrhGPfwXD)
                    ...
                    child: Column(
                      ...
                      children: [
                        Container(
                          // quesadilladequesillo15Soh (6:26)
                        ...
                        Container(
                          // autogroupserd9y1 (qVUXimUV2xYD2173cSeRd)
                          ...
                          child: Row(
                            ...
                            children: [
                              Container(
                                // autogroupbl3zGXq (qVUiiT9wcAeXWnAuSBL3Z)
                              ...
                              TextButton(
                                // autogrouprnxqphm (qVUdPGhnEnxZ6HHpcRnXq)
                                onPressed: () {},
                                style: TextButton.styleFrom (
                                  padding: EdgeInsets.zero,
                                ),
